...
public class ActivityRequest {
    ...
    public ActivityRequest(String activityName, int taskId, int priority, String description, Date plannedStartDate, Date plannedEndDate, float plannedBudget, Date actualStartTime, Date actualEndTime, float actualBudget) {
