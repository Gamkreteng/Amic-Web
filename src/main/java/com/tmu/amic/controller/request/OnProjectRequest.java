...
public class OnProjectRequest {
    ...
    public OnProjectRequest() {
    }

    public OnProjectRequest(int projectId, int clientPartnerId, Date dateStart, Date dateEnd, boolean isClient, boolean isPartner, String description) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OnProjectRequest)) return false;
        OnProjectRequest that = (OnProjectRequest) o;
